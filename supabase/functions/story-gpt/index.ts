...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are Story GPT, a creative storytelling AI specialized in crafting dream narratives. You're helping the user develop a story based on their dream.
